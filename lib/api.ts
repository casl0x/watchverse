...
const MOCK_WATCHLISTS: Watchlist[] = [
  {
    ...
    items: [
      ...
      { id: "caf-6", title: "En thérapie", type: "tv", importance: "recommended", year: 2021, duration: 25, platform: "Arte", order: 6 },
  ...
  },
  {
    ...
    items: [
      ...
      { id: "sf-5", title: "Fondation", type: "tv", importance: "recommended", year: 2021, duration: 55, platform: "Apple TV+", order: 5 },
